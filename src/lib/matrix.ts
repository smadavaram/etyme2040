      ...
      { code: 'L2.4.2', name: 'Accounts receivable', domain: 'MONEY', processes: [
        { code: 'L3.4.2.1', name: 'AR aging and dunning', owner: 'AR clerk', status: B,
          ...
          implementedBy: ['src/lib/money/desks.ts',
            'src/lib/ar-ageing.ts', 'src/app/api/ar/route.ts',
  ...
  },
  {
    ...
    groups: [
      { code: 'L2.6.1', name: 'The ledger', domain: 'MONEY', processes: [
        ...
        { code: 'L3.6.1.2', name: 'The master contract — the deal, revenue side and cost side', owner: 'Controller', status: P,
          tasks: ['Collects revenue and cost for one piece of work', 'Allocations per head', 'Basis stated on every line',
            ...
            'NOT YET: `orderFor` groups lines by engagement, so the system still decides the grouping. The screen where a company tags a line to a master contract is etyme-money’s, after the header-and-lines pieces land'],
