...
export const BUILT_IN: DocumentTypeSpec[] = [
  ...
  spec({
    ...
    hint: 'Signed by the person or the firm and by us; a term, not a lifetime.',
    purpose: 'AGREEMENT',
    validityShape: 'START_AND_END',
    signedBy: 'BOTH_PARTIES',
    suppliedBy: 'CLIENT',
  ...
  spec({
    ...
    hint: 'The contract between an employer and its own W2, on the buy line that pays them.',
    purpose: 'AGREEMENT',
    validityShape: 'START_AND_END',
    signedBy: 'ONE_PARTY',
    suppliedBy: 'EMPLOYEE',
