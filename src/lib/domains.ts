...
export const DOMAINS: Domain[] = [
  ...
  },
  {
    ...
    owns: [
      ...
      'app/api/timesheets', 'app/api/people', 'app/api/identity', 'app/api/first-good', 'app/api/favorites', 'lib/network-filters', 'lib/supplier-onboarding', 'app/api/supplier-requests',
    ],
  },
  {
    key: 'SUPPLY',
