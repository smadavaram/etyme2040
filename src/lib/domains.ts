...
export const DOMAINS: Domain[] = [
  {
    ...
    owns: [
      ...
      'lib/work-authorisation', 'lib/visa-worksite', 'lib/sourcing-exit', 'lib/sourcing-approach', 'lib/candidate-fixture', 'lib/profile-readiness', 'lib/rate-negotiation', 'lib/bench-consent',
